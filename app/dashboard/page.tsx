...
if (loading) {
return ( <main className="min-h-screen flex items-center justify-center bg-[#faf9f5]"> <p className="text-gray-600">Loading...</p> </main>
);
}
...
Your community dashboard </p> </div>
  ...
  <section className="mx-auto max-w-7xl px-6 py-10">
    ...
    <div className="mt-8 grid gap-5 md:grid-cols-3">
      ...
      >
        ...
        <h3 className="mt-4 text-xl font-bold">I Have Something</h3>
      ...
      >
        <div className="text-4xl">🙋</div>
        <h3 className="mt-4 text-xl font-bold">I Need Something</h3>
        <p className="mt-2 text-sm text-gray-600">
      ...
      >
        <div className="text-4xl">🔎</div>
        <h3 className="mt-4 text-xl font-bold">Browse Items</h3>
        <p className="mt-2 text-sm text-gray-600">
    ...
    <div className="mt-8 grid gap-5 md:grid-cols-2">
      ...
      <div className="rounded-2xl bg-[#f1eee6] p-7">
        ...
        <p className="mt-3 text-gray-600">
          Let's reduce waste and build a helpful local community together.
        </p>
      </div>
    </div>
  </section>
